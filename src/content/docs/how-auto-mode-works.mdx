...
For practical tips on running auto mode — starting, pausing, steering, and controlling costs — see [Auto Mode](/auto-mode/).
...
**For the full generated reference** — event types, tool signatures, and the complete auto-mode prompt — see [Auto Mode](../auto-mode/).
