...
Run `/gsd` and describe the bug when the smart entry wizard asks what you're working on. Or, if you already have a project and want to jump straight to milestone creation, run `/gsd new-milestone`:
...
:::tip
Want to review decisions before planning begins? Run [`/gsd discuss`](../../commands/discuss/) for a guided interview about the slice — UX, behaviour, edge cases — before letting auto mode take over.
:::
    ...
    └── M003/
        ...
        └── slices/
            └── S01/
                ...
                ├── S01-ASSESSMENT.md    ← roadmap reassessment notes
                └── tasks/
                    ├── T01-PLAN.md
                    ├── T01-SUMMARY.md
                    ├── T02-PLAN.md
...
| `.gsd/milestones/M003/slices/S01/S01-ASSESSMENT.md` | Roadmap reassessment after slice completes |
