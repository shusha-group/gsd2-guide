...
**What stays local** (gitignored): lock files, SQLite cache (including WAL sidecars), state cache, activity logs, doctor run history, daily event journal, runtime records, and worktrees.
