...
When auto-mode detects a unit is stuck (same unit re-dispatched without completing), it automatically advances the pipeline. `/gsd skip` gives you the same outcome manually — before the stuck counter triggers, or after you've investigated and decided not to retry.
