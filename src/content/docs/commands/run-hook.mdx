...
flowchart TD
    ...
    PostCheck -->|No| TriggerFail([Error: hook may be disabled<br/>or wrong unit type])
...
| File | Purpose |
|------|---------|
| `.gsd/auto.lock` | Session lock file written for the hook unit |
| `.gsd/runtime/units/hook-<name>-<unitId>.json` | Runtime record tracking the hook unit's dispatch phase and timeout state |
