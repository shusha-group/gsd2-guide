...
flowchart TD
    ...
    Select --> AlreadyDiscussed{Already has CONTEXT?}
...
- [`guided-discuss-milestone`](../../prompts/guided-discuss-milestone/) — Milestone interview prompt (needs-discussion phase)
