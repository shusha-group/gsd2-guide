...
| File | Purpose |
|------|---------|
| `.gsd/STATE.md` | Rebuilt from derived state before each dispatch |
...
| `.gsd/milestones/<MID>/<MID>-CONTEXT-DRAFT.md` | Incremental draft saved every 2 question rounds during milestone-level discussions |
