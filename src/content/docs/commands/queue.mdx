---
title: "/gsd queue"
description: "Manage the milestone execution queue — reorder pending milestones, resolve dependency conflicts, and add new work via LLM-assisted discussion."
---
...
flowchart TD
    ...
    Verify --> Write[Write CONTEXT.md via gsd_summary_save]
...
| `d` / `D` | Remove the first active `depends_on` from the cursor item |
...
- [`/gsd discuss`](../discuss/) — Start a milestone discussion without the full queue flow
