...
flowchart TD
    ...
    Empty -->|Yes| GetLast[Sort by sequence — take most recent]
...
⚠ Will undo: execute-task (M001/S01/T01)
  This will:
    ...
    - Uncheck task in PLAN.md (if execute-task)
