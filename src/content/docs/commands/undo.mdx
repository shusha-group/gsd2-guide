---
title: "/gsd undo"
description: "Revert the last completed unit — deletes artifacts, unchecks the task in PLAN, and stages git reverts."
---
...
| `/gsd undo --force` | Execute — deletes artifacts, unchecks PLAN, reverts commits |
