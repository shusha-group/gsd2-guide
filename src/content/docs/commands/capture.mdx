...
After triage, actionable captures (`inject`, `replan`, `quick-task`) accumulate as unexecuted resolutions. Auto-mode picks these up between tasks and dispatches them at the appropriate seam.
