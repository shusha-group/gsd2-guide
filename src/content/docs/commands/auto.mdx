...
- [`complete-slice`](../../prompts/complete-slice/) — Verifies that all tasks in a slice actually deliver the slice goal, then compres…
- [`execute-task`](../../prompts/execute-task/) — The core executor prompt
- [`plan-milestone`](../../prompts/plan-milestone/) — Reads milestone research and decomposes the work into demoable, risk-ordered sli…
- [`plan-slice`](../../prompts/plan-slice/) — Decomposes a slice into a set of executable tasks, each sized to fit one context…
- [`reassess-roadmap`](../../prompts/reassess-roadmap/) — Reviews the milestone roadmap after each slice completes, deciding whether remai…
- [`replan-slice`](../../prompts/replan-slice/) — Rewrites the remaining tasks in a slice when a blocker is discovered mid-executi…
- [`research-milestone`](../../prompts/research-milestone/) — Opens the auto-mode pipeline by scouting the codebase and producing a research d…
- [`research-slice`](../../prompts/research-slice/) — Scouts the codebase at the start of each slice, producing a research document th…
