...
GSD API Key Manager
  ...
  LLM Providers
  ✓ anthropic             — OAuth (expires in 2h 14m)
  ✓ openai                — API key (sk-p***7890)
  ✗ google                — not configured (aistudio.google.com/apikey)
  …
  ...
  2 configured | 1 in auth.json | 1 from env | 1 OAuth
```
...
API Key Test Results
  ...
  — github-copilot        — uses credential chain (not testable)
