...
Keys are always masked in output — only the first 4 and last 4 characters are shown (e.g. `sk-a***cdef`). Keys shorter than 12 characters show only the first 2 and last 2.
