...
| `preparationContext` | Injected preparation context block assembled by the dispatcher — codebase snapshot, existing planning artifacts, and any prior discussion state the agent should be aware of before the first question round | Yes |
