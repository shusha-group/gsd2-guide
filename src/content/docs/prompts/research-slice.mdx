...
The researcher calibrates depth to the actual complexity of the work. For well-understood patterns already present in the codebase, a light research document — confirming the existing pattern and noting any constraints — is more valuable than invented complexity. For slices involving unfamiliar APIs, risky integrations, or genuinely ambiguous scope, the researcher explores broadly, looks up docs, and investigates multiple approaches before writing findings.
