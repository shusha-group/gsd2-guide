...
所有 20+ provider 的完整配置方式请见 [提供商设置指南](../providers/)。
...
完整的配置、资源限制和 compose 文件请见 [Docker Sandbox 文档](../../../docker/)。
...
也可以在偏好设置中按阶段配置模型，详见 [配置](../configuration/)。
...
- [自动模式](../auto-mode/)：深入理解自主执行
- [配置](../configuration/)：模型选择、超时和预算
- [命令参考](../commands/)：所有命令和快捷键
- [提供商设置](../providers/)：每个 provider 的详细配置
- [团队协作](../working-in-teams/)：多开发者工作流
