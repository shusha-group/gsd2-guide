...
→ gsd2-guide: [Control Your Costs recipe](../../recipes/control-your-costs/) — detailed how-to for budgets, token profiles, dynamic routing, and monitoring\
→ gsd2-guide: [Cost Management](../../cost-management/)\
