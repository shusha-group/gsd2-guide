...
For the full preference reference and per-project configuration patterns, see the [Configuration](../../configuration/) page. For a detailed breakdown of how auto mode uses these preferences at each phase, see [How Auto Mode Works](../../how-auto-mode-works/).
