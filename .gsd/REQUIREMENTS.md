...
### R073 — Changelog summary digest
- Class: primary-user-loop
- Status: active
- Description: Each release version gets a 2–4 line solo-builder-perspective summary highlighting the 3–5 most relevant changes. Summaries categorise changes into workflow impact, cost/performance, stability/fixes, new commands. Generated by the update pipeline.
- Why it matters: 88 releases of full changelog detail is unscannable. Solo builders need an opinionated summary layer.
- Source: user
- Primary owning slice: M007/S02
- Supporting slices: none
- Validation: unmapped
- Notes: Pipeline-generated via AI during npm run update. Full changelog preserved unchanged.

### R074 — Changelog GitHub issue auto-linking
- Class: integration
- Status: active
- Description: Every #NNN reference in the changelog renders as a clickable hyperlink to the corresponding GitHub issue/PR on gsd-build/gsd-2.
- Why it matters: 875 issue references are currently plain text. Users who want context behind a fix must manually construct the URL.
- Source: user
- Primary owning slice: M007/S02
- Supporting slices: none
- Validation: unmapped
- Notes: Render-time transform in ReleaseEntry.astro. No source data changes.

### R075 — Quick reference page
- Class: primary-user-loop
- Status: active
- Description: A curated page showing 10–15 most commonly used GSD commands with one-line descriptions, workflow context, and critical flags. Grouped by workflow phase. Links to full command pages.
- Why it matters: 50+ commands overwhelm new users. No "start here" quick reference exists.
- Source: user
- Primary owning slice: M007/S01
- Supporting slices: none
- Validation: unmapped
- Notes: Fits on ~2 phone screens. Includes 3–4 key keyboard shortcuts.

### R076 — Cross-referenced content consolidation
- Class: core-capability
- Status: active
- Description: Key official GSD 2 doc content integrated into the guide in its own voice: auto mode 12-point breakdown, .gsd/ directory structure, verification ladder, v1→v2 comparison, git strategy gaps, token optimisation gaps, and preferences summary with link.
- Why it matters: Users currently bounce between two documentation sources. The guide should be self-sufficient for 90% of solo-builder workflow.
- Source: user
- Primary owning slice: M007/S03
- Supporting slices: none
- Validation: unmapped
- Notes: Narrative integration, not copy-paste. Attribution to official docs included.

### R077 — "Is GSD right for me?" decision guide
- Class: primary-user-loop
- Status: active
- Description: A 30-second-read assessment that helps someone decide whether GSD suits their situation. Clear routing: if X, GSD helps; if Y, use Claude Code directly. Honest about where GSD adds overhead that doesn't pay off.
- Why it matters: Neither the official docs nor this guide currently helps someone assess fit before committing to learning the tool.
- Source: user
- Primary owning slice: M007/S01
- Supporting slices: none
- Validation: unmapped
- Notes: Does not oversell GSD. Appears before or at top of Solo Guide section.

### R078 — Writing a good brief guide
- Class: core-capability
- Status: active
- Description: A subsection or recipe teaching solo builders how to write effective requirements and milestone descriptions. Concrete bad-vs-good examples with downstream consequences.
- Why it matters: Quality of GSD output depends directly on quality of input. Most common mistakes are preventable.
- Source: user
- Primary owning slice: M007/S04
- Supporting slices: none
- Validation: unmapped
- Notes: References the "technical director" mental model. 1–2 pages max.

### R079 — Concrete cost examples
- Class: operability
- Status: active
- Description: At least 3 concrete cost scenarios with approximate dollar ranges for typical milestones at different scales and token profiles. Includes Claude Max note and brief comparison to Cursor Pro/Replit Core.
- Why it matters: Cost is currently an abstract concept. Solo builders need a mental model of what a typical week costs.
- Source: user
- Primary owning slice: M007/S04
- Supporting slices: none
- Validation: unmapped
- Notes: Ranges, not precise figures. Clearly marked as approximate.

### R080 — Navigation and information architecture improvements
- Class: quality-attribute
- Status: active
- Description: Sidebar restructured for logical flow. Quick reference near top. Changelog highlights as default changelog view. Decision guide at top of Solo Guide. Cross-links between related pages. No existing URLs broken.
- Why it matters: New content needs to be discoverable. Current sidebar order doesn't surface the most useful entry points.
- Source: user
...
### R081 — Rewriting existing Solo Guide sections 1–8
- Class: constraint
- Status: out-of-scope
- Description: Rewriting the existing Solo Guide content (Sections 1–8).
- Why it matters: Content is already strong. Prevents scope creep into unnecessary rewrites.
- Source: user
- Primary owning slice: none
- Supporting slices: none
- Validation: n/a
- Notes: New content supplements existing sections; does not replace them.

### R082 — Full official configuration reference duplication
- Class: constraint
- Status: out-of-scope
- Description: Duplicating the complete official configuration reference into this guide.
- Why it matters: Frequently-changing content should link to the official source, not duplicate it.
- Source: user
- Primary owning slice: none
- Supporting slices: none
- Validation: n/a
- Notes: Link to official docs with a brief summary of the 5 most important preferences instead.

### R083 — Video or interactive tutorial content
- Class: constraint
- Status: out-of-scope
- Description: Video walkthroughs or interactive tutorials.
- Why it matters: Different content medium, different production pipeline, different maintenance burden.
- Source: user
- Primary owning slice: none
- Supporting slices: none
- Validation: n/a
- Notes: Text-based documentation only for this milestone.
