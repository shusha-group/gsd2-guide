...
### R048 — Replace API-based page regeneration with Claude Code (`claude -p`) invocation
- Class: core-capability
- Status: active
...
### R051 — Verify all 43 page-source-map entries correctly identify source files
- Class: completeness
- Status: active
...
- Supporting slices: none
- Validation: unmapped
- Notes: All 43 paths are structurally valid (no missing files in manifest) but semantic correctness is unverified.

### R052 — Full end-to-end cycle proven on real stale pages
- Class: operability
- Status: active
...
### R053 — "Update gsd-guide" completes end-to-end with zero intervention
- Class: operability
- Status: active
...
### R054 — Remove `@anthropic-ai/sdk` dependency and all API-key-based regeneration code
- Class: constraint
- Status: active
...
### R055 — Fast path when no pages are stale
- Class: operability
- Status: active
...
### R056 — Graceful degradation when `claude` CLI is absent
- Class: operability
- Status: active
...
- Active requirements: 9 (R048–R056)
- Mapped to slices: 9
- Validated: 41 (R001–R046 exc. deferred/oos)
