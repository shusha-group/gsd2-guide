...
- [x] **T03: Add Header/Footer component overrides, prebuild script, and Mermaid wiring** `est:1h`
...
- [x] **T04: Create placeholder content pages demonstrating all component variants** `est:45m`
